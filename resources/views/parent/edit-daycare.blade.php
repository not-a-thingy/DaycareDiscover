...
<body>
    <div class="container" style= "margin: left 50;">
        ...
        <div class="card" style="width:100%;">
            ...
            <form class="card-footer" method="POST" action="{{ route('parent.update_review',$daycare->firstReview()->id) }}">
                @csrf
                @method('PUT')
                ...
                <div class="form-group ">
                    ...
                    placeholder="Review comment" value=" {{ $daycare->firstReview()->review_comment }}"> {{ $daycare->firstReview()->review_comment }}
                    </textarea>
                </div>
                <input type="submit" value="update rview" class="btn btn-primary">
            </form>
        </div>
</body>
</html>
